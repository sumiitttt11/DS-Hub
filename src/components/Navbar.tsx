...
import { Laptop2, Users, GraduationCap, BookOpen, MessageCircle, Users2, Menu, X } from 'lucide-react';
...
const Navbar = () => {
  ...
  const navItems = [
    { path: '/', icon: <Laptop2 className="w-5 h-5" />, label: 'Home' },
    { path: '/faculty', icon: <GraduationCap className="w-5 h-5" />, label: 'Faculty' },
    { path: '/dssa', icon: <Users className="w-5 h-5" />, label: 'DSSA' },
